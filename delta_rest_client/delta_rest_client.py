...
class DeltaRestClient:
  ...
  def place_bracketorder(self, product_id,product_symbol,  limit_price=None, time_in_force=None, order_type=OrderType.LIMIT, post_only='false', client_order_id = None):
    order = {
      'product_id'      : product_id,
